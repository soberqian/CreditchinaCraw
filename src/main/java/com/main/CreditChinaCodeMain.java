...
public class CreditChinaCodeMain {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i < 6; i++) {
			String html=request.getHTMLContentByHttpGetMethod("https://www.creditchina.gov.cn/api/credit_info_search?objectType=2&page="+i+"&pageSize=10&creditType=2&_=1523273080466","UTF-8");
			//解析红名单数据
			List<ListInfoModel> list = Parse.getcodedata(html);
			//存储数据
